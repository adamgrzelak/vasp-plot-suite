...
class MainWindow(object):
    def setupUi(self, Window):
        ...
        self.DosButton.setStyleSheet("background-color: #d90d1f; color: white;")
        ...
        self.BandsButton.setStyleSheet("background-color: #642870; color: white;")
        ...
        self.label_2.setGeometry(QRect(100, 170, 400, 25))
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line.setGeometry(QRect(27, 320, 551, 20))
    ...
    def retranslateUi(self, Window):
        ...
        self.label_2.setText(_translate("Window", "Which output data would you like to analyze?"))
